...
for i in range(1, 11):
    ...
    input_layer = Input(shape=(9, 9, 20, 1), name='Pavia_Input')
...
#第一层
    ...
    conv_layer13 = Conv3D(filters=16, kernel_size=(3, 3, 20))(relu12)
...
#反向传播
    ...
    filepath = 'TKSN-9x9x20 - 1%' + "Window Size" + str(windowSize) + "num" + str(numPCAcomponents)\
               + str(i) + '.hdf5'
